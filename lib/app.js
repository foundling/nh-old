...
var lookup = function(token) {
    ...
    switch(typeof token) {
        ...
        case 'function':    nativeDocs = app.repl.context._db['Native']['Function'];
                            rv = deNest(nativeDocs);
                            break;

        case 'object':      nativeDocs = app.repl.context._db['Native']['Object'];
                            rv = deNest(nativeDocs);
                            break;

        case 'string':      nativeDocs = app.repl.context._db['Native']['String'];
                            rv = deNest(nativeDocs);
                            break;
